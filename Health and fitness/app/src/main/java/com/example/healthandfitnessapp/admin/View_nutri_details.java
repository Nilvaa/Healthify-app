...
public class View_nutri_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_nutri_details);
        ...
        edit.setOnClickListener(v -> {
            Intent intent=new Intent(getApplicationContext(), Edit_nutri_plan.class);
            Bundle bundle=new Bundle();
            bundle.putString("nu_id", nid);
            bundle.putString("p_nam", pna);
