...
import com.example.healthandfitnessapp.admin.View_workout_details;
...
public class Admin_workout_adaptor extends ArrayAdapter<Healthify_Model> {

    Activity context;
    List<Healthify_Model> list;
    CardView card;
    public Admin_workout_adaptor(Activity context, List<Healthify_Model> list) {
        super(context, R.layout.activity_admin_workout_adaptor, list);
        this.list = list;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.activity_admin_workout_adaptor, null, true);
        ...
        card.setOnClickListener(v -> {
            ...
            Intent intent=new Intent(getContext(), View_workout_details.class);
