...
public class User_add_medicine extends AppCompatActivity {
    EditText med_nam,dosage,des;
    Button med;
    ImageView vi;
    Spinner med_food;
    CheckBox checkMorning, checkAfternoon, checkNight;
    String u_id,me,dos,food,de,timeofday;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user_add_medicine);
        med_nam=findViewById(R.id.nam);
        vi=findViewById(R.id.log);
        dosage=findViewById(R.id.dos);
        med=findViewById(R.id.btnmed);
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("profileprefer", Context.MODE_PRIVATE);
         u_id = sharedPreferences.getString("UID", "");
            ...
            public void onClick(View v) {
                if (u_id != null) {
                    ...
                    startActivity(new Intent(getApplicationContext(), User_view_medicine.class)
                            .putExtra("user_id", u_id));
                } else {

                    Toast.makeText(getApplicationContext(), "User ID not available", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        med.setOnClickListener(v -> {
            ...
            if (me.isEmpty()) {
                Snackbar.make(med_nam, "Please Enter Medicine Name", Snackbar.LENGTH_LONG)
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    Toast.makeText(User_add_medicine.this, "Medicine Added successful ", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(), User_view_medicine.class));
                } else {
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "AddMedicine");
