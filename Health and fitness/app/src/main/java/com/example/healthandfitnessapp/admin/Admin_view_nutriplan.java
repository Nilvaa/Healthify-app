...
public class Admin_view_nutriplan extends AppCompatActivity {
    ListView list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_nutriplan);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent=new Intent(getApplicationContext(), View_nutri_details.class);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    adap = new Nutri_adaptor(Admin_view_nutriplan.this, arraylist);
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "AdminViewNutriPlan");
                return map;
            }
        };
        queue.add(request);
